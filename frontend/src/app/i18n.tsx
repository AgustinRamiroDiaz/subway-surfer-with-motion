...
const translations = {
  es: {
    ...
    'controls.cameraPreview': 'Mostrar vista',
    'controls.cameraPreviewHelp': 'Muestra u oculta la vista previa y el overlay de cámara. La detección puede seguir corriendo sin la vista visible.',
  ...
  en: {
    ...
    'controls.cameraPreview': 'Show preview',
    'controls.cameraPreviewHelp': 'Shows or hides the visible camera preview and overlay. Detection can keep running without the visible view.',
