...
const translations = {
  es: {
    ...
    'game.calibrationRequired': 'Levanten los brazos para calibrar',
    'game.calibrating': 'Brazos arriba {progress}%',
    'game.pause': 'Pausar',
    ...
    'controls.multiplierNone': 'Ninguno',
    'controls.cameraMultiplierHelp': 'Modo de prueba para desarrollo que multiplica el cuadro de cámara a lo largo del eje X antes de enviarlo al detector. Se reinicia automáticamente si la cámara está activa.',
  ...
  en: {
    ...
    'game.calibrationRequired': 'Raise arms to calibrate',
    'game.calibrating': 'Arms up {progress}%',
    'game.pause': 'Pause',
    ...
    'controls.multiplierNone': 'None',
    'controls.cameraMultiplierHelp': 'Developer test mode that multiplies the camera frame along the X axis before the detector receives it. Restart is automatic while the camera is active.',
