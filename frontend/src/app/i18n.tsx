...
const translations = {
  es: {
    ...
    'home.menu': 'Menú de minijuegos',
    'home.eyebrow': 'Tablero de minijuegos',
    'home.title': 'Elige tu carrera',
    'home.sidewaysTitle': 'Carrera lateral',
    'home.jumpDuckTitle': 'Saltos y agaches',
    'home.handRhythmTitle': 'Ritmo de manos',
    'home.poseInput': 'Pose',
    'home.gestureInput': 'Gestos',
    'home.quickStart': 'Inicio rápido',
    'home.calibration': 'Calibración',
    'home.autoCalibrate': 'Se calibra automáticamente al iniciar',
    ...
    'camera.readinessOff': 'Cámara no preparada',
    'camera.readinessLoading': 'Preparando cámara y detector',
    'camera.readinessReady': 'Cámara lista para iniciar',
    'camera.readinessActive': 'Cámara y detector activos',
    ...
    'game.title': 'Webcam Motion Games',
    ...
    'game.countIn': 'Prepárate · {beat}',
    'game.handReady': 'Palmas abiertas al centro · {ready}/{total}',
    ...
    'game.pause': 'Pausar',
    'game.pausedTitle': '¿Qué sigue?',
    'game.pausedBody': 'Tu partida está en pausa. La cámara sigue encendida, así que reanudar es instantáneo.',
    'game.resume': 'Reanudar',
    'game.resumeHelp': 'Retoma justo donde lo dejaste.',
    'game.changeLevel': 'Cambiar de nivel',
    'game.changeLevelHelp': 'Vuelve al tablero de niveles. No se pierde nada.',
    'game.exitStopCamera': 'Salir y apagar cámara',
    'game.exitStopCameraHelp': 'Apaga la cámara. Vuelve a iniciar desde el tablero para reanudar.',
    'game.stats': 'Estadísticas del juego',
    'game.handRhythmScores': 'Puntuación por jugador',
    'game.playerScore': 'Puntuación del jugador {player}',
    'game.dodged': 'Esquivados',
    'game.hits': 'Golpes',
    'game.rhythmHits': 'Aciertos',
    'game.misses': 'Fallos',
    ...
    'controls.cameraTrackingTitle': 'Cámara y seguimiento',
    'controls.menu': 'Menú',
    'controls.hidePanel': 'Ocultar panel',
    'controls.showPanel': 'Mostrar panel',
    'controls.camera': 'Cámara',
    'controls.overlayGroup': 'Vista del juego',
    ...
    'controls.cameraPreview': 'Mostrar overlay del nivel',
    'controls.cameraPreviewHelp': 'Muestra u oculta la cámara y sus guías en el nivel actual. Cada nivel recuerda su propia opción y la detección puede seguir funcionando sin el overlay.',
    'controls.detectionOverlay': 'Mostrar detección',
    'controls.detectionOverlayHelp': 'Muestra u oculta los puntos, marcadores y guías del detector. Esta opción es independiente de la cámara.',
    ...
    'controls.song': 'Canción', 'controls.songHelp': 'Elige la música para este nivel. La jugabilidad sigue el ritmo de la canción.',
    ...
    'controls.handRhythmGrid': 'Cuadrícula de manos',
    'controls.handRhythmGridHelp': 'Elige el tamaño de la cuadrícula para Ritmo de manos.',
    'controls.handRhythmGrid2': '2 × 2',
    'controls.handRhythmGrid3': '3 × 3',
    'controls.handRhythmDifficulty': 'Dificultad',
    'controls.handRhythmDifficultyHelp': 'Cambia la densidad de objetivos, la variedad de gestos, las ráfagas y los objetivos para ambas manos.',
    'controls.handRhythmDifficultyEasy': 'Fácil',
    'controls.handRhythmDifficultyMedium': 'Media',
    ...
    'controls.renderFps': 'FPS de renderizado',
    'controls.renderFpsHelp': 'Limita cuántas veces por segundo el juego envía trabajo gráfico a la GPU. La simulación y el detector siguen funcionando de forma independiente.',
    'controls.renderFpsValue': '{fps} FPS',
    ...
    'timing.model': 'Modelo',
    'timing.recognition': 'Reconocimiento',
    'timing.gestureSetup': 'Config. gesto',
    'timing.gestureDecode': 'Decodif. gesto',
    'timing.postprocess': 'Postprocesado',
    'timing.analysis': 'Asignación',
    'timing.draw': 'Dibujo',
    'timing.overhead': 'Transferencia',
    'timing.total': 'Total',
  ...
  en: {
    ...
    'home.menu': 'Minigame menu',
    'home.eyebrow': 'Minigame board',
    'home.title': 'Choose your run',
    'home.sidewaysTitle': 'Sideways runner',
    'home.jumpDuckTitle': 'Jump and duck',
    'home.handRhythmTitle': 'Hand Rhythm',
    'home.poseInput': 'Pose',
    'home.gestureInput': 'Gestures',
    'home.quickStart': 'Quick start',
    'home.calibration': 'Calibration',
    'home.autoCalibrate': 'Auto-calibrates when you start',
    ...
    'camera.readinessOff': 'Camera not ready',
    'camera.readinessLoading': 'Preparing camera and detector',
    'camera.readinessReady': 'Camera ready to start',
    'camera.readinessActive': 'Camera and detector active',
    ...
    'game.countIn': 'Count in · {beat}',
    'game.handReady': 'Open palms in the center · {ready}/{total}',
    'game.playerHit': 'P{player} hit',
    'game.calibrationRequired': 'Raise arms to calibrate',
    'game.calibrating': 'Arms up {progress}%',
    'game.pause': 'Pause',
    'game.pausedTitle': 'What next?',
    'game.pausedBody': 'Your run is on hold. The camera stays on, so resuming is instant.',
    'game.resume': 'Resume',
    'game.resumeHelp': 'Pick up right where you left off.',
    'game.changeLevel': 'Change level',
    'game.changeLevelHelp': 'Back to the level board. Nothing here is lost.',
    'game.exitStopCamera': 'Exit & stop camera',
    'game.exitStopCameraHelp': 'Turns the camera off. Start again from the board to resume.',
    'game.stats': 'Game stats',
    'game.handRhythmScores': 'Scores by player',
    'game.playerScore': 'Player {player} score',
    'game.dodged': 'Dodged',
    'game.hits': 'Hits',
    'game.rhythmHits': 'Hits',
    'game.misses': 'Misses',
    ...
    'controls.cameraTrackingTitle': 'Camera & tracking',
    'controls.menu': 'Menu',
    'controls.hidePanel': 'Hide panel',
    'controls.showPanel': 'Show panel',
    'controls.camera': 'Camera',
    'controls.overlayGroup': 'Game view',
    ...
    'controls.cameraPreview': 'Show level overlay',
    'controls.cameraPreviewHelp': 'Shows or hides the camera and guides for the current level. Each level remembers its own setting, and detection can keep running without the overlay.',
    'controls.detectionOverlay': 'Show detection overlay',
    'controls.detectionOverlayHelp': 'Shows or hides detector points, markers, and guides. This setting is independent from the camera feed.',
    ...
    'controls.song': 'Song', 'controls.songHelp': 'Choose the music for this level. Gameplay follows the song’s rhythm.',
    ...
    'controls.handRhythmGrid': 'Hand grid',
    'controls.handRhythmGridHelp': 'Choose the grid size for Hand Rhythm.',
    'controls.handRhythmGrid2': '2 × 2',
    'controls.handRhythmGrid3': '3 × 3',
    'controls.handRhythmDifficulty': 'Difficulty',
    'controls.handRhythmDifficultyHelp': 'Changes target density, gesture variety, bursts, and two-hand targets.',
    'controls.handRhythmDifficultyEasy': 'Easy',
    'controls.handRhythmDifficultyMedium': 'Medium',
    ...
    'controls.renderFps': 'Render FPS',
    'controls.renderFpsHelp': 'Limits how often the game submits graphics work to the GPU. Game simulation and detection continue independently.',
    'controls.renderFpsValue': '{fps} FPS',
    ...
    'timing.gestureSetup': 'Gesture setup',
    'timing.gestureDecode': 'Gesture decode',
    'timing.postprocess': 'Postprocess',
    'timing.analysis': 'Assignment',
    'timing.draw': 'Draw',
    'timing.overhead': 'Transfer',
    'timing.total': 'Total',
    'people.title': 'People',
