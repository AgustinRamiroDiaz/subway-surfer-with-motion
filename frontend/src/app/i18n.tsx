...
const translations = {
  es: {
    ...
    'controls.handRhythmDoubleTargetChanceHelp': 'Probabilidad de que aparezcan dos objetivos para el mismo jugador al mismo tiempo.',
  ...
  en: {
    ...
    'controls.handRhythmDoubleTargetChanceHelp': 'Chance that two targets appear at the same time for the same player.',
